...
//import com.papaymoni.middleware.dto.AdSearchRequest;
...
//        try {
//            log.info("Fetching Bybit ads with criteria: {}", searchRequest);
//
//            // Get the actual User entity from the repository
//            User user = userRepository.findByUsername(currentUser.getUsername())
//                    .orElseThrow(() -> new RuntimeException("User not found"));
...
//
//            BybitCredentials credentials = bybitCredentialsService.getCredentialsByUser(user);
//            BybitApiResponse<?> bybitResponse = bybitApiService.getAds(
//                    searchRequest.getTokenId(),
//                    searchRequest.getCurrencyId(),
//                    searchRequest.getSide(),
//                    credentials);
//
//            ApiResponse response = new ApiResponse();
//            response.setSuccess(bybitResponse.isSuccess());
//            response.setMessage(bybitResponse.isSuccess() ? "Bybit ads retrieved successfully" : bybitResponse.getRetMsg());
//            response.setData(bybitResponse.getResult());
//
//            return ResponseEntity.ok(response);
//        } catch (Exception e) {
//            log.error("Error retrieving Bybit ads", e);
//
//            ApiResponse response = new ApiResponse();
//            response.setSuccess(false);
//            response.setMessage("An unexpected error occurred: " + e.getMessage());
